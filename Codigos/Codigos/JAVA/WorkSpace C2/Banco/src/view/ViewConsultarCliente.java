...
public class ViewConsultarCliente extends JInternalFrame  {
	...
	public ViewConsultarCliente( Observador observador ) {
		...
		btnConsultar.setIcon(new ImageIcon(ViewConsultarCliente.class.getResource("/resource/procurar.png")));
		btnConsultar.setSelectedIcon(new ImageIcon(ViewConsultarCliente.class.getResource("/resource/procurar.png")));
		...
		btnLimpar.setIcon(new ImageIcon(ViewConsultarCliente.class.getResource("/resource/botaoLimpar.png")));
		...
		btnInserir.setIcon(new ImageIcon(ViewConsultarCliente.class.getResource("/resource/inserir.png")));
		...
		btnEditar.setIcon(new ImageIcon(ViewConsultarCliente.class.getResource("/resource/edit.png")));
