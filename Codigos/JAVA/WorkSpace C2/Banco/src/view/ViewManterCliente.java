...
public class ViewManterCliente extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ViewManterCliente ( Observador ctrl_observador ) {
		this.observador = ctrl_observador;
		setResizable(false);
		setAlwaysOnTop(true);
		setTitle("Cadastro de Clientes");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ViewManterCliente.class.getResource("/resource/favicon.ico")));
		...
		btnSalvar.setIcon(new ImageIcon(ViewManterCliente.class.getResource("/resource/gravar.png")));
		...
		btnExcluir.setIcon(new ImageIcon(ViewManterCliente.class.getResource("/resource/excluir.png")));
		...
		btnFechar.setIcon(new ImageIcon(ViewManterCliente.class.getResource("/resource/fechar.png")));
		acoes.add(btnFechar);
