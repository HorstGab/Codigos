...
//--------------------------------------------------------------------------  right handed, y up
#declare Camera_0 = camera {/*ultra_wide_angle*/ angle 15      // front view from z-
...
#declare Camera_1 = camera {/*ultra_wide_angle*/ angle 14   // diagonal view
                            ...
                            right    -x*image_width/image_height
                            look_at   <0.0 , 1 , 0.0>}
#declare Camera_2 = camera {/*ultra_wide_angle*/ angle 30  //right side view from x+
                            location  <3.0 , 1.0 , 0.0>
                            right    -x*image_width/image_height
                            look_at   <10.0 , 1.0 , 0.0>}
#declare Camera_3 = camera {/*ultra_wide_angle*/ angle 65        // top view from y+ (x right, z up)
                            location  <-0.001 , 10.0 , 0>
                            right    -x*image_width/image_height
                            look_at   <0.0 , 1.0 , 0.0>}
camera{Camera_1}
//------------------------------------------------------------------------
...
union{
 ...
 text   { ttf "arial.ttf",  "y",  0.15,  0  texture{Tex_Dark}    
          rotate<-20,0,0> scale 0.65 translate <-0.65,AxisLenY+0.50,-0.10>  rotate<0,45,0> no_shadow}
#end // of #if 
#if (AxisLenZ != 0)
...
cone { <0,0,0>,0.75,<0,1.50,0>,0 
       ...
       scale <0.5,0.5,0.5> rotate<0,0,0> translate<0,0,3>         
     } // end of cone -------------------------------------           
...
box { <-1.00, 0.00, -1.00>,< 1.00, 2.00, 1.00>   
      ...
      scale <0.5,0.5,0.5> rotate<0,0,0> translate<0,2,0> 
    } // end of box --------------------------------------
